    ...
    <main className="page" aria-labelledby="reconciliation-title">
      ...
      <div className="data-table-wrap">
        <table className="data-table">
          <thead><tr><th>Settlement</th><th>UTR</th><th className="amount">Expected settlement</th><th className="amount">Bank credit</th><th className="amount">Difference</th><th>Evidence</th><th>Decision</th><th><span className="sr-only">Action</span></th></tr></thead>
